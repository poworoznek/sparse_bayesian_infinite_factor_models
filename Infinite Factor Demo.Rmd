...
Now we generate the outcome accorting with a linear regression with pairwise interactions. We assume that the first family has a positive effect on the health response and second family negative. We add some interactions between the chemicals within and between families. 
