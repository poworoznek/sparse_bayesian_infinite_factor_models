...
In our simulated study, we observe three families of chemicals, that show high correlation within each family. We assume that each group of chemicals

In particular, we can think of each chemical of a linear combination of latent factors. 
...
generate_DL_reg(S = 10000, k = 5, p = 20,
...
```{r, echo = FALSE}
generate_DL_reg(S = 10000, k = 10, p = 20,
                a_DL = 0.5, var_omega = 5,
                as = 1, bs = 0.3,
                trace = FALSE, every = 500)
```
