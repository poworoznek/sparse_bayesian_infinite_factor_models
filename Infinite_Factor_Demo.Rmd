...
```{r}
n = 400;
X = matrix(rnorm(n*k0),n,k0)%*%t(lambda) + bayesSurv::rMVNorm(n,Sigma = diag(p))
X = scale(X)

# maybe heatmap correlation on X
beta_true = numeric(p); beta_true[c(1,3,6,8,11)] = c(1,1,-1,-1,2)
Omega_true = matrix(0,p,p)
Omega_true[1,2] = 1; Omega_true[5,2] = -1; Omega_true[10,8] = 1; 
Omega_true[11,5] = -2; Omega_true = Omega_true + t(Omega_true)
